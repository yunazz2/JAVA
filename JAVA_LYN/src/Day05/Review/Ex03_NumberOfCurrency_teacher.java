...
public class Ex03_NumberOfCurrency_teacher {
	...
	public static void main(String[] args) {
		...
		int list[] = {50000, 10000, 5000, 1000, 500, 100, 50, 10, 5, 1}; // money대신 list[index]로 써도 좋다.
		int index = 0;
		...
		while (index < 10) {
			...
			System.out.println(list[index] + "\t 원권 : " + count + "개"); // \t(백슬래시t) : 탭 만큼 공백 생성
